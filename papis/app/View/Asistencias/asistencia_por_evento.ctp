			...
			<div class="btn-group col-lg-5">
				...
				<h3 class="text-primary text-right ">
					...
					<div class="text-right">
						...
						<?php echo $this->Form->postLink(' ', array('controller' => 'asistencias', 'action'=>'editar_asistencia_por_evento', $evento_id, $grupo), array('class'=>"btn btn-primary glyphicon glyphicon-edit")); ?>		
...
<?php foreach ($asistencias as $a): ?>
			...
			<td><?php echo $a['Asistencia']['asistencia']; ?></td>
			<td><?php echo $a['Asistencia']['observaciones']; ?></td>
